...
from utils.liferay_utils.jira.jira_constants import Status, CustomField, Filter, Transition, Strings
        ...
        if table_starring_string:
            ...
            try:
                if is_automation_task_needed:
                    ...
                    if not poshi_task:
                        close_functional_automation_subtask(jira, story, 'the testing task linked in the story.')
                    else:
